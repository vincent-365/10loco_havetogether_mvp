                        ...
                        Kakao.Auth.login({
                            ...
                            success: function() {
                                Kakao.API.request({
                                    ...
                                    data: {
                                        template_object: {
                                            ...
                                            content: {
                                                ...
                                                link: {
                                                    mobile_web_url: 'https://havetogether.com/confirm/index.php?id=<? echo $id; ?>&name=' + name,
                                                    web_url: 'https://havetogether.com/confirm/index.php?id=<? echo $id; ?>&name=' + name,
                                                },
                                            },
                                            buttons: [{
                                                title: '약속확인',
                                    ...
                                    success: function(res) {
                                        location.href = 'https://havetogether.com/confirm/index.php?id=<? echo $id; ?>&name=' + name;
                                    },
                                    fail: function(err) {
        ...
        function sendLinkDefault() {
            Kakao.Link.sendDefault({
                ...
                content: {
                    ...
                    link: {
                        mobileWebUrl: 'https://havetogether.com/meet/?id=<? echo $id; ?>',
                        webUrl: 'https://havetogether.com/meet/?id=<? echo $id; ?>',
                    },
                },
                buttons: [{
                    title: '약속잡기',
